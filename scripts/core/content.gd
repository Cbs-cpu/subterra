...
const ENEMIES := {
	...
	"chaman_tiki": {"name": "Chamán de la tribu", "ai": "tirador", "hp": 12, "dmg": 2, "speed": 40, "size": [8, 15], "xp": 9,
		"coins": [2, 5], "drops": [["piel", 0.4], ["bicho_fuego", 0.05]], "spr": "humano:tiki_chaman", "proj": "espora", "range": 140},
	"porrero_tiki": {"name": "Porrero de la tribu", "ai": "caminante", "hp": 18, "dmg": 2, "speed": 45, "size": [8, 15], "xp": 9,
	...
	"seta_soldado": {"name": "Seta soldado", "ai": "caminante", "hp": 24, "dmg": 3, "speed": 45, "size": [8, 15], "xp": 12,
		"coins": [3, 6], "drops": [["pocion_vida", 0.25], ["seta", 0.3]], "spr": "humano:seta_soldado"},
	"seta_maga": {"name": "Seta maga", "ai": "tirador", "hp": 16, "dmg": 3, "speed": 40, "size": [8, 15], "xp": 12,
	...
	"esqueleto_guerrero": {"name": "Esqueleto guerrero", "ai": "caminante", "hp": 36, "dmg": 4, "speed": 50, "size": [8, 15],
		"xp": 18, "coins": [5, 10], "drops": [["hueso", 0.8], ["mandoble", 0.02]], "spr": "humano:esqueleto"},
	"esqueleto_arquero": {"name": "Esqueleto arquero", "ai": "tirador", "hp": 28, "dmg": 4, "speed": 40, "size": [8, 15],
		"xp": 18, "coins": [5, 10], "drops": [["hueso", 0.8], ["flecha_hueso", 0.4]], "spr": "humano:esqueleto_arquero",
		"proj": "flecha_enemiga", "range": 200},
	"minotauro": {"name": "Minotauro", "ai": "embestidor", "hp": 80, "dmg": 6, "speed": 170, "size": [12, 22], "xp": 40,
		"coins": [10, 20], "drops": [["pellejo", 0.6], ["granhacha_hierro", 0.05]], "spr": "humano:minotauro", "range": 140, "scale": 1.4},
	"genio": {"name": "Genio de la lámpara", "ai": "tirador", "hp": 40, "dmg": 4, "speed": 40, "size": [8, 15], "xp": 22,
		"coins": [8, 16], "drops": [["gema_rayo", 0.1], ["anillo_sabiduria", 0.03]], "spr": "humano:genio", "flying": true,
		"proj": "bola_magica", "range": 180},
	"caballero_hielo": {"name": "Caballero de hielo", "ai": "caminante", "hp": 50, "dmg": 4, "speed": 45, "size": [8, 15],
	...
	"esqueleto_cosmico": {"name": "Esqueleto cósmico", "ai": "tirador", "hp": 110, "dmg": 8, "speed": 55, "size": [8, 15],
	...
	"necrofago": {"name": "Necrófago", "ai": "caminante", "hp": 140, "dmg": 9, "speed": 60, "size": [8, 15], "xp": 70,
	...
	"zombi_aliado": {"name": "Muerto aliado", "ai": "aliado", "hp": 30, "dmg": 0, "speed": 60, "size": [8, 15], "xp": 0,
	...
	"corsario": {"name": "Corsario Morsa", "ai": "jefe_corsario", "hp": 600, "dmg": 4, "speed": 70, "size": [14, 30], "xp": 200,
		"coins": [40, 80], "drops": [["vial_veneno", 1.0], ["piel", 0.6], ["anillo_poder", 0.2]], "spr": "humano:corsario", "boss": true, "scale": 2.0},
	...
	"rey_esqueleto": {"name": "Rey Esqueleto", "ai": "jefe_rey_esqueleto", "hp": 600, "dmg": 5, "speed": 60, "size": [14, 30],
		"xp": 250, "coins": [50, 100], "drops": [["mandoble", 0.4], ["hueso", 1.0], ["llave", 0.5]], "spr": "humano:rey_esqueleto",
		"boss": true, "scale": 2.0, "flying": true},
	"yeti": {"name": "Yeti", "ai": "jefe_yeti", "hp": 150, "dmg": 4, "speed": 40, "size": [16, 30], "xp": 80, "coins": [20, 40],
		"drops": [["vial_veneno", 1.0], ["pellejo", 1.0]], "spr": "humano:yeti", "boss": true, "scale": 2.0},
	"reina_escarcha": {"name": "Reina de Escarcha", "ai": "jefe_reina", "hp": 850, "dmg": 4, "speed": 50, "size": [14, 30],
		"xp": 350, "coins": [60, 100], "drops": [["gema_hielo", 1.0], ["anillo_sabiduria", 0.3]], "spr": "humano:reina_escarcha",
		"boss": true, "scale": 2.0, "flying": true, "armor": 13},
	...
	"paladin_cuarzo": {"name": "Paladín de Cuarzo", "ai": "jefe_paladin", "hp": 300, "dmg": 7, "speed": 80, "size": [14, 30],
		"xp": 300, "coins": [60, 120], "drops": [["arco_cristal", 0.2], ["mena_diamante", 1.0]], "spr": "humano:paladin", "boss": true, "scale": 2.0},
	"capitan_estelar": {"name": "Capitán Estelar", "ai": "jefe_capitan", "hp": 1700, "dmg": 8, "speed": 70, "size": [14, 30],
		"xp": 700, "coins": [120, 200], "drops": [["espada_laser", 1.0]], "spr": "humano:capitan", "boss": true, "scale": 2.0},
	...
	"ventolin": {"name": "Sir Ventolín", "ai": "jefe_ventolin", "hp": 4000, "dmg": 7, "speed": 35, "size": [14, 30], "xp": 1500,
		"coins": [200, 400], "drops": [["guarda_paladin", 1.0]], "spr": "humano:ventolin", "boss": true, "scale": 2.0, "flying": true, "noclip": true},
