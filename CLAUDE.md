...
- Interfaz: todo texto se dibuja con `UiKit` (paleta verde/amarilla, `max_w` para que quepa). Tras tocar la UI, ejecuta el juego con `-- --ui-audit` (con ventana, no headless): debe acabar en `UI TOTAL problemas: 0`.
